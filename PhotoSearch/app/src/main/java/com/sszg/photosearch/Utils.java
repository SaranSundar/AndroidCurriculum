...
public final class Utils {
    ...
    public static Uri.Builder getUri(String query) {
        ...
        uriBuilder.appendQueryParameter("cx", "002740584417081531455:fnr_tspgkay");
        uriBuilder.appendQueryParameter("safe", "high");
        uriBuilder.appendQueryParameter("searchType", "image");
        uriBuilder.appendQueryParameter("key", "AIzaSyAtZOdbcj1HFdnhp-yjxpSRAMqCYjgkzsg"); // <--YOUR-API-KEY_HERE
